...
def populate():
    # First, create lists of dictionaries containing the pages we wish to add
    # into each category
    ...
    python_pages = [
        ...
        {"title": "Learn Python in 10 Minutes", "url": "http://korokithakis.net/tutorials/python/", "views": 8}]
